...
export default function MarketPanel({ marketImpacts, onClose }: MarketPanelProps) {
  return (
    <>
      ...
      />
      <div className="fixed inset-y-0 right-0 w-[420px] bg-[#0a0e16]/98 border-l border-emerald-500/20 backdrop-blur-xl z-50 flex flex-col shadow-2xl shadow-black/50">
